...
return(
            ...
            <div>
                <fieldset className="border-2 border-black py-5 mt-8 lg:mt-10 lg:py-8 2xl:mt-16">
                    <legend className="text-center font-extrabold text-xl md:text-4xl 2xl:text-7xl lg:text-5xl">Academic Qualification</legend>
                    ...
                    <div className="flex 2xl:px-10 2xl:py-16 xl:py-14 ml-5">
                        ...
                        <select name="education" value={education} onChange={onEducationChange} required className="rounded-sm lg:rounded-2xl border-2 border-gray-400  w-44 h-8 font-normal lg:w-60 lg:h-12 2xl:w-80 2xl:h-16 xl:w-60 xl:h-12 text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">
